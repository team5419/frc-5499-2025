...
public class LightsSubsystem extends SubsystemBase {
    ...
    // Disabled gradient
    private final LEDPattern disabledPattern = LEDPattern.gradient(GradientType.kContinuous, Color.kRed, Color.kOrange);

    // L1 pattern
    private final LEDPattern l1Pattern =
            LEDPattern.steps(Map.of(0, Color.kRed, 0.33, Color.kOrange, 0.66, Color.kOrange));

    // L2 pattern
    private final LEDPattern l2Pattern =
            LEDPattern.steps(Map.of(0, Color.kOrange, 0.33, Color.kRed, 0.66, Color.kOrange));

    // L3 pattern
    private final LEDPattern l3Pattern =
            LEDPattern.steps(Map.of(0, Color.kOrange, 0.33, Color.kOrange, 0.66, Color.kRed));
